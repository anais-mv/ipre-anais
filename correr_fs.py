...
archivo = "archivos terminal//terminal fs LISTA G -- " + file_name.replace("grafos//grafo_", "")[:-7] + ".txt"
...
for k in valores_k:
    ...
    nombre = file_name + f"--fs--k={k} - LMCUT NUEVO.pickle"
    file = open(nombre, "wb")
    pickle.dump(dato, file)
    nombre_g = file_name + f"--fs--k={k} LISTA G.pickle"
