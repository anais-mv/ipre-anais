...
def correr_fs(heuristica, grafo, inicial, objetivo, op, prop, file_name, iteracion, prom):
    ...
    for weight in weights:
        ...
        print(f"-------------------W: {weight}-------------------")
        a_star = Astar(inicial, objetivo, op, heuristica, prop, weight, "zero")
        ...
        for mse in mses:
            ...
            print("nodos expandidos focal:", fs.expansions, "- g:", result.g)
            inicio = time.process_time()
            fs = FocalSearch(grafo.estado_inicial, a_star.perfect_heuristic, lm_cut, 1000)
            ...
            print("nodos expandidos focal discrepancy position:", fs.expansions, "- g:", result.g)
            inicio = time.process_time()
            fs = FocalSearch(grafo.estado_inicial, a_star.perfect_heuristic, lm_cut, 1000)
            ...
            print("nodos expandidos focal discrepancy best:", fs.expansions, "- g:", result.g)
            print("\n")
